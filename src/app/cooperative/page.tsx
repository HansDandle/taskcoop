...
export const metadata: Metadata = {
  title: 'Worker Ownership — The Co-op Model',
  description: 'task.coop is built as a worker-owned cooperative. Learn about our model, our values, and the roadmap to full democratic ownership.',
}
...
export default function CooperativePage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-14">
      ...
      <h1 className="text-3xl font-bold text-stone-900 mb-4">Workers own this platform.</h1>
      <p className="text-lg text-stone-500 mb-12 leading-relaxed">
        Most gig platforms extract value from workers. task.coop is built to do the opposite — distribute it.
      </p>
      ...
      <div className="space-y-12">
        <section>
          ...
          <div className="text-stone-600 space-y-4 leading-relaxed">
            <p>Platforms like TaskRabbit and Thumbtack take 15–30% of every job. They set the rules, raise fees whenever they want, and workers have no say.</p>
            <p>task.coop is structured as a worker-owned cooperative. That means the members — the people doing the actual work — have a stake in the platform and, eventually, a vote in how it's run.</p>
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              { title: 'Low fees', body: '5% platform fee. Workers keep 95% of every job.' },
              ...
              { title: 'Dispute resolution', body: 'Real human review for disputes, not automated bans.' },
            ].map((item) => (
        ...
        <section>
          ...
          <div className="space-y-4">
            {[
              ...
              { phase: 'Q3 2026', label: 'Member equity', desc: 'Active workers earn equity units based on platform activity. Equity tracked transparently.' },
              { phase: 'Q1 2027', label: 'Profit sharing', desc: 'Platform surplus distributed to member-workers proportional to their contribution.' },

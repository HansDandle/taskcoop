      ...
      <div className="w-full max-w-md text-center space-y-6 rounded-xl border border-stone-200 bg-white p-10 shadow-sm">
        ...
        <div>
          ...
          <p className="mt-2 text-stone-500 text-sm leading-relaxed">
            {email
              ? <>We sent a confirmation link to <span className="font-medium text-stone-700">{email}</span>. Click it to activate your account and get started.</>
        ...
        <p className="text-xs text-stone-400">
          Already confirmed? <Link href="/login" className="text-emerald-600 hover:underline">Log in</Link>.
        </p>
      </div>
    </div>
  )

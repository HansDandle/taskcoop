  ...
  return (
    <div className="rounded-lg border border-stone-200 bg-stone-50 px-4 py-4 space-y-2 text-xs text-stone-500 leading-relaxed">
      ...
      <ul className="space-y-1.5 list-none">
        <li className="flex gap-2"><span className="text-emerald-500 shrink-0">✓</span>Members see only your ZIP until you accept an offer — then your full address is shared.</li>
